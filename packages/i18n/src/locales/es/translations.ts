...
export default {
  ...
  workspace_member_modals: {
    ...
    leave_description: "¿Estás seguro de que quieres abandonar el espacio de trabajo {name}?",
    remove_member_title: "¿Eliminar miembro?",
    remove_member_description:
      "¿Estás seguro de que quieres eliminar al miembro {name}? Ya no tendrá acceso a este espacio de trabajo.",
  },
  importer: {
    label: "Importar",
    title: "Importar datos",
    description: "Importa datos de otras herramientas a tu proyecto de Plane.",
    github: {
      title: "GitHub",
  ...
  exporter: {
    ...
    description: "Exporta todos los datos del proyecto a un archivo CSV o JSON.",
    csv: {
      title: "CSV",
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        delete: "Eliminar",
        copy_id: "Copiar ID",
        copy_id_toast_success: "ID del elemento de trabajo copiado al portapapeles.",
        copy_id_toast_error: "Ocurrió un error al copiar el ID del elemento de trabajo al portapapeles.",
        copy_title: "Copiar título",
        copy_title_toast_success: "Título del elemento de trabajo copiado al portapapeles.",
        copy_title_toast_error: "Ocurrió un error al copiar el título del elemento de trabajo al portapapeles.",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL del elemento de trabajo copiado al portapapeles.",
        copy_url_toast_error: "Ocurrió un error al copiar la URL del elemento de trabajo al portapapeles.",
      },
      cycle: {
        ...
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL del ciclo copiado al portapapeles.",
      ...
      module: {
        ...
        remove_from_favorites: "Quitar de favoritos",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL del módulo copiado al portapapeles.",
      ...
      page: {
        ...
        remove_from_favorites: "Quitar de favoritos",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL de la página copiado al portapapeles.",
      ...
      view: {
        ...
        remove_from_favorites: "Quitar de favoritos",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL de la vista copiado al portapapeles.",
        copy_url_toast_error: "Ocurrió un error al copiar la URL de la vista al portapapeles.",
      },
    },
    common: {
      all: "Todos",
      ...
      views: "Vistas",
      pages: "Páginas",
      no_matching_results: "No se encontraron resultados coincidentes",
